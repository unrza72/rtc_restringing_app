...
function TimetableCard({
  ...
  // Offered only when widening would actually reveal something.
  const wanted = windowCovering(plain, gridWindow)
  const covering =
    wanted.startMin === gridWindow.startMin &&
    wanted.endMin === gridWindow.endMin
      ? null
      : wanted
